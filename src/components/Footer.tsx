        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex items-center gap-3">
              <Link href="#" aria-label="Instagram" className="p-2 rounded-full bg-white/5 text-white/50 hover:text-white hover:bg-white/10 transition-all">
                <Instagram size={18} />
              </Link>
              <Link href="#" aria-label="Twitter" className="p-2 rounded-full bg-white/5 text-white/50 hover:text-white hover:bg-white/10 transition-all">
                <Twitter size={18} />
              </Link>
